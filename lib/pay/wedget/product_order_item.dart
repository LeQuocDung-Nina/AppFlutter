      ...
      children: [
        ...
        Expanded(
          ...
          child: Column(
            ...
            children: [
              Text(product_order_item.title,style: TextStyle(color: color_lqd5,fontSize: 15),),
              SizedBox(height: 10,),
              RichText(text: TextSpan(
                  style: TextStyle(color: color_lqd1,fontSize: 18),
                  children: [
              ...
              RichText(text: const TextSpan(
                  style: TextStyle(color: color_lqd12,fontSize: 15),
                  children: [
                    TextSpan(text: "x",),
                    TextSpan(text: "1",),
                  ]
